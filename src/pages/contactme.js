...
const ContactMe = () => {
    return (
        <div className="bg-gradient-to-b bg-white text-stone-700 h-screen flex flex-col justify-center items-center">
            <h1 className=" text-center md:text-7xl sm:text-5xl text-5xl font-extralight mb-14">
                ...
                <br />
                <a href='https://www.calendly.com/nathan-pegram/introductory-meeting' target='_blank' rel='noreferrer noopener'>
                    <div className='hover:text-neutral-400 transition duration-1000 1s ease-in-out infinite underline decoration-rose-200'>
                        let's chat!
                        <button>
