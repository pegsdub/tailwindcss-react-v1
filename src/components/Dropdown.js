...
const Dropdown = ({ isOpen, toggle }) => {
    return (
        <div className={isOpen ? 'rounded-md grid grid-rows-3 text-center items-center m-2 mx-8  text-stone-700 font-extralight shadow-md hover:grid-rows-3' : 'hidden'} onClick={toggle}>
